...
void Server::start() {
    try{
        ...
        while(true) {
            ...
            threads.back().detach();
            //todo this was an infinite loop and then the join threads was never reached, do we need the joined threads?
            // 2 and 3 dont work, once they do check if 4 and 5 work
            // hand everything in except .o and .out and only the cmake , only cpp and h and maybe cmakelist?
